...
module.exports = function ff(mod) {
	...
	function load() {
		...
		hook('C_START_INSTANCE_SKILL', 7, { order: -100 }, ({ skill, loc, w, targets }) => {
			...
			mod.send('S_ABNORMALITY_BEGIN', 4, { target: mod.game.me.gameId, source: mod.game.me.gameId, id: 2112, duration: 0, unk: 0, stacks: 1, unk2: 0, unk3: 0 });
			mod.send('S_ABNORMALITY_BEGIN', 4, { target: mod.game.me.gameId, source: mod.game.me.gameId, id: 2060, duration: 0, unk: 0, stacks: 1, unk2: 0, unk3: 0 });
			setTimeout(() => {
